...
<body style="font-family: sans-serif; color: #333; line-height: 1.6; padding: 20px;">
    ...
    <p>Le informamos que los análisis clínicos correspondientes a su orden de servicio
        ...
        responsable.</p>
    <p>Adjunto a este correo electrónico encontrará los informes oficiales en formato PDF listos para su descarga o
        impresión.</p>
    <br>
    <p style="font-size: 11px; color: #7c728a;"><em>Nota: Este es un mensaje automatizado, por favor no responda
            directamente a esta dirección de correo.</em></p>
</body>
