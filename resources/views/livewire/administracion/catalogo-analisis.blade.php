            ...
            <div class="bg-white shadow-sm rounded-2xl p-5 border border-gray-100 h-[75vh] flex flex-col">
                ...
                <div class="flex-1 overflow-y-auto pr-2 custom-scrollbar space-y-2">
                    <div wire:click="seleccionarCategoria(null)"
                        class="p-3 rounded-xl cursor-pointer border transition-all flex justify-between items-center {{ $categoria_seleccionada_id === null ? 'bg-blue-600 border-blue-600 text-white shadow-md' : 'bg-gray-50 border-gray-200 text-gray-700 hover:bg-gray-100' }}">
                    ...
                    @foreach ($categorias as $cat)
                        <div
                            ...
                            {{ $categoria_seleccionada_id === $cat->id ? 'bg-blue-50 border-blue-200 text-blue-800 shadow-sm' : 'bg-white border-gray-200 text-gray-700 hover:border-blue-300' }}">

                            <div wire:click="seleccionarCategoria({{ $cat->id }})" class="cursor-pointer flex-1">
                            ...
                            @forelse($analisis as $ana)
                                <tr class="hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="p-3 text-center">
                                        @if ($ana->tipo_parámetro === 'numerico')
                                            <span
                                                class="bg-blue-50 text-blue-600 text-[10px] px-2 py-1 rounded font-bold border border-blue-100">123
                                                Numérico</span>
                                        @else
                                            <span
                                                class="bg-purple-50 text-purple-600 text-[10px] px-2 py-1 rounded font-bold border border-purple-100">Abc
                                                Cualitativo</span>
                                        @endif
                                    </td>
                                    ...
                                    <td class="p-3 flex justify-center gap-2">
                                        <button wire:click="abrirModalAnalisis({{ $ana->id }})"
        ...
        <div class="fixed inset-0 z-50 overflow-y-auto flex items-center justify-center p-4">
            ...
            <div class="relative bg-white rounded-2xl text-left overflow-hidden shadow-xl w-full max-w-md">
                <div class="bg-blue-600 px-6 py-4 flex items-center justify-between">
                    ...
                    <button wire:click="$set('mostrarModalCategoria', false)" class="text-blue-200 hover:text-white"><i
                ...
                <div class="p-6">
                    ...
                    <input type="text" wire:model="cat_nombre"
                        class="w-full bg-gray-50 border border-gray-300 rounded-lg p-2.5 text-gray-900 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div class="p-6 max-h-[70vh] overflow-y-auto custom-scrollbar">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6 pb-6 border-b border-gray-100">
                        <div>
                            ...
                            <select wire:model="ana_categoria_id"
                                ...
                                <div class="bg-white p-4 rounded-lg border border-gray-200">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <input type="number" step="0.01" wire:model="ana_rango_min_m"
                                            class="w-1/2 border-gray-300 rounded p-2 text-sm" placeholder="Mínimo">
                                        <span class="text-gray-400">-</span>
                                        <input type="number" step="0.01" wire:model="ana_rango_max_m"
                                            class="w-1/2 border-gray-300 rounded p-2 text-sm" placeholder="Máximo">
                                    </div>
                                </div>
                                <div class="bg-white p-4 rounded-lg border border-gray-200">
                                    <p
