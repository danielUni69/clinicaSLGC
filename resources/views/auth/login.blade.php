            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                ...
                <div class="p-8 md:p-10 bg-gradient-to-b from-sky-50 to-white">
                    <div class="flex items-center gap-3">
                        <div class="relative">
                            ...
                            <img src="{{ asset('img/logo.png') }}" alt="Logo"
                                class="relative w-14 h-14 shadow-lg object-cover rounded-2xl bg-white p-2">
                        </div>
                        <div>
                    ...
                    <form method="POST" action="{{ route('login.post') }}" class="space-y-5">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-sky-500" fill="none" viewBox="0 0 24 24"
                                        stroke="currentColor">
                        ...
                        <div>
                            <label for="password"
                                class="block text-sm font-semibold text-slate-700 mb-2">Contraseña</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-sky-500" fill="none" viewBox="0 0 24 24"
                                        stroke="currentColor">
                ...
                <div
                    class="hidden md:flex items-center justify-center p-10 bg-[radial-gradient(circle_at_top,rgba(56,189,248,0.22),transparent_55%)]">
                    <div
                        class="w-full max-w-sm rounded-3xl border border-sky-100 bg-white/70 backdrop-blur p-8 shadow-sm">
                        <div class="text-center">
                            ...
                            <p class="mt-2 text-slate-600 text-sm">Un lugar para turnos, resultados y reportes en un
                                solo sistema.</p>
                        </div>
