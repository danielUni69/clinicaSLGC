                    ...
                    @auth
                        <div class="dropdown relative">
                            <div class="flex items-center space-x-3 cursor-pointer">
                                ...
                                <div
                                    class="w-8 h-8 clinic-gradient rounded-full flex items-center justify-center shadow-lg">
                            ...
                            <div class="dropdown-menu right-0 mt-2">
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                    <button type="submit"
                                        class="w-full text-left block px-4 py-2 text-red-400 hover:bg-red-900 hover:text-white transition">
                        ...
                        <div class="flex space-x-1">
                            ...
                            @if (Auth::user()->role === 'administrador')
                                <div class="dropdown relative group">
                                    <button
                                        class="nav-item flex items-center space-x-2 px-4 py-3 text-gray-200 rounded-t-lg w-full h-full cursor-pointer focus:outline-none {{ request()->routeIs('admin.*') ? 'active' : '' }}">
                                    ...
                                    <div class="dropdown-menu left-0 mt-0 w-56 py-2">
                                        ...
                                        <a href="#"
                                            class="block px-4 py-2 text-gray-200 hover:bg-gray-700 hover:text-white transition text-sm opacity-50 cursor-not-allowed">
